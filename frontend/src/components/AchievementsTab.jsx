    ...
    <div className="space-y-6">
            ...
            <div className="relative w-20 h-20 flex items-center justify-center">
              ...
              <svg className="w-full h-full transform -rotate-90 absolute">
                ...
                <circle
                  ...
                  fill="transparent"
                  strokeDasharray={213}
                  strokeDashoffset={213 - (213 * 82.6) / 100}
                  strokeLinecap="round"
                />
              </svg>
          ...
          <div className="flex-1 space-y-4 text-left w-full">
            <div>
              ...
              <div className="flex items-center gap-3 font-mono text-[9.5px] text-zinc-500 dark:text-zinc-400 mt-2 font-bold">
                <span>NEXT_TIER: 15,000 XP</span>
                <span className="text-emerald-500 dark:text-emerald-400 bg-emerald-500/5 px-2 py-0.5 rounded border border-emerald-500/10">
                  ELO.PROJECTION: +142
                </span>
              </div>
            </div>
            ...
            <div>
              <div className="w-full bg-zinc-100 dark:bg-[#121620] border border-zinc-200 dark:border-zinc-900/60 rounded-full h-3 overflow-hidden">
                <div className="bg-[#3b82f6] h-3 rounded-full transition-all shadow-[0_0_10px_rgba(59,130,246,0.35)]" style={{ width: '82.6%' }} />
              </div>
              <div className="flex justify-between items-center text-[10px] text-zinc-500 dark:text-[#3b82f6] font-mono font-bold mt-1.5">
                <span className="text-zinc-500">12,400 XP</span>
          ...
          <div className="flex flex-row lg:flex-col justify-between items-center lg:items-end gap-6 shrink-0 w-full lg:w-auto border-t lg:border-t-0 lg:border-l border-zinc-250 dark:border-zinc-900 pt-4 lg:pt-0 lg:pl-6 text-right">
            <div>
              ...
              <span className="text-3xl font-black text-[#2563eb] dark:text-[#3b82f6] font-mono tracking-tight leading-none block">
                1,450 <span className="text-xs font-bold text-zinc-400 uppercase tracking-widest ml-0.5">ELO</span>
              </span>
            </div>

            <div className="font-mono text-[9px] space-y-0.5 text-left lg:text-right font-bold">
              <div>SYSTEM.STATUS: <span className="text-emerald-500">ACTIVE</span></div>
              <div className="text-zinc-500">SESSION_TIME: 09:12:33</div>
              <div className="text-zinc-500">DETERMINATION: MAX</div>
            </div>
          </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-[#080b11]/60 border border-zinc-200 dark:border-[#171c26] rounded-lg p-5 flex items-center justify-between relative shadow-2xl transition-colors">
          ...
          <div className="text-left font-mono">
            ...
            <span className="block text-xl font-black text-[#3b82f6] tracking-wide mt-1.5 leading-none">
              412 <span className="text-[10px] font-bold text-zinc-500 uppercase">Solved</span>
            </span>
          </div>
        ...
        <div className="bg-white dark:bg-[#080b11]/60 border border-zinc-200 dark:border-[#171c26] rounded-lg p-5 flex items-center justify-between relative shadow-2xl transition-colors">
          ...
          <div className="text-left font-mono">
            ...
            <span className="block text-xl font-black text-emerald-500 tracking-wide mt-1.5 leading-none">
              Top 2% <span className="text-[10px] font-bold text-zinc-500 uppercase">Global</span>
            </span>
          </div>
        ...
        <div className="bg-white dark:bg-[#080b11]/60 border border-zinc-200 dark:border-[#171c26] rounded-lg p-5 flex items-center justify-between relative shadow-2xl transition-colors">
          ...
          <div className="text-left font-mono">
            <span className="block text-[8.5px] text-zinc-550 dark:text-zinc-400 font-bold uppercase tracking-wider">Session Logic</span>
            <span className="block text-xl font-black text-purple-600 dark:text-purple-400 tracking-wide mt-1.5 leading-none">
              14 <span className="text-[10px] font-bold text-zinc-500 uppercase">Streak</span>
            </span>
          </div>
      ...
      <section className="bg-white dark:bg-[#080b11]/60 border border-zinc-200 dark:border-[#171c26] rounded-lg p-6 relative overflow-hidden shadow-2xl transition-colors">
        ...
        {/* Responsive viewport scrollable path wrapper */}
        <div className="relative w-full max-w-[600px] h-[650px] mx-auto select-none overflow-hidden">
          ...
          <svg className="absolute inset-0 w-full h-full pointer-events-none" viewBox="0 0 600 650" fill="none">
            ...
            <path 
              ...
              strokeDasharray="6,6"
            />
            {/* 2. Active Glowing Trail Path (Blue Connection for completed sections) */}
            <path 
              d="M 288 598 C 340 560, 360 540, 348 507 C 330 460, 240 450, 228 416"
              className="stroke-[#3b82f6]"
              strokeWidth="4"
              strokeDasharray="6,6"
              strokeLinecap="round"
          ...
          {/* Node 1: LEGENDARY GRANDMASTER */}
          <div className="absolute top-[8%] left-[48%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1.5">
            <div className="w-9 h-9 rounded border border-zinc-300 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-950/80 flex items-center justify-center text-zinc-400 dark:text-zinc-650">
              <Lock className="w-4 h-4" />
            </div>
            <span className="font-mono text-[8px] font-bold text-zinc-400 dark:text-zinc-650 uppercase tracking-widest text-center whitespace-nowrap">
              Legendary Grandmaster
            </span>
          </div>

          {/* Node 2: MASTER GUARDIAN */}
          <div className="absolute top-[22%] left-[58%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1.5">
            <div className="w-9 h-9 rounded border border-zinc-300 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-950/80 flex items-center justify-center text-zinc-400 dark:text-zinc-650">
              <Lock className="w-4 h-4" />
            </div>
            <span className="font-mono text-[8px] font-bold text-zinc-400 dark:text-zinc-650 uppercase tracking-widest text-center whitespace-nowrap">
          ...
          {/* Node 3: ELITE KNIGHT */}
          <div className="absolute top-[36%] left-[38%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1.5">
            <div className="w-9 h-9 rounded border border-zinc-300 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-950/80 flex items-center justify-center text-zinc-400 dark:text-zinc-650">
              <Lock className="w-4 h-4" />
            </div>
            <span className="font-mono text-[8px] font-bold text-zinc-400 dark:text-zinc-650 uppercase tracking-widest text-center whitespace-nowrap">
          ...
          {/* Node 4: CRUSADER */}
          <div className="absolute top-[50%] left-[50%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1.5">
            <div className="w-9 h-9 rounded border border-zinc-300 dark:border-zinc-800 bg-zinc-100 dark:bg-zinc-950/80 flex items-center justify-center text-zinc-400 dark:text-zinc-650">
              <Lock className="w-4 h-4" />
            </div>
            <span className="font-mono text-[8px] font-bold text-zinc-400 dark:text-zinc-650 uppercase tracking-widest text-center whitespace-nowrap">
          ...
          {/* Node 5: [ GUARDIAN ] */}
          <div className="absolute top-[64%] left-[38%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1.5">
            <div className="w-10 h-10 rounded border border-blue-500/40 dark:border-blue-500/20 bg-blue-500/5 dark:bg-[#0c1017] flex items-center justify-center text-[#2563eb] dark:text-[#3b82f6]">
              <Hourglass className="w-4.5 h-4.5" />
            </div>
            <span className="font-mono text-[8.5px] font-bold text-[#2563eb] dark:text-[#3b82f6] uppercase tracking-wider text-center whitespace-nowrap">
              [ Guardian ]
            </span>
          </div>

          {/* Node 6: [ KNIGHT ] - Current Active */}
          <div className="absolute top-[78%] left-[58%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1.5">
            <div className="w-12 h-12 rounded bg-blue-600 dark:bg-[#2563eb] border-2 border-blue-400/80 flex items-center justify-center text-white shadow-[0_0_18px_rgba(37,99,235,0.45)]">
          ...
          {/* Node 7: BEGINNER - Completed */}
          <div className="absolute top-[92%] left-[48%] -translate-x-1/2 -translate-y-1/2 flex flex-col items-center gap-1.5">
            <div className="w-9 h-9 rounded-full bg-emerald-500/10 border border-emerald-500/70 flex items-center justify-center text-emerald-600 dark:text-emerald-400">
              <Check className="w-4 h-4 stroke-[3px]" />
            </div>
            <span className="font-mono text-[8.5px] font-bold text-emerald-600 dark:text-emerald-400 uppercase tracking-widest text-center whitespace-nowrap">
              Beginner
            </span>
          </div>
      ...
      <section className="space-y-4 text-left">
        ...
        <div className="flex gap-5 overflow-x-auto pb-3 pr-1 scrollbar-thin scroll-smooth select-none">
          ...
          <div className="flex flex-col items-center shrink-0">
            ...
            <span className="text-[8.5px] font-mono font-bold text-zinc-400 dark:text-zinc-500 mt-2 block">06.24.2026</span>
          </div>

          {/* Badge 5: Date B */}
          <div className="flex flex-col items-center shrink-0">
            <div className="w-14 h-14 rounded-full flex items-center justify-center border-2 border-dashed border-zinc-500/30 bg-zinc-50 dark:bg-zinc-950/20 hover:border-zinc-500 transition-colors relative cursor-pointer group">
              <div className="absolute inset-0.5 rounded-full border border-dashed border-zinc-400/10" />
              <CheckCircle2 className="w-5 h-5 text-zinc-450 dark:text-zinc-500 group-hover:scale-110 transition-transform" />
            </div>
            <span className="text-[8.5px] font-mono font-bold text-zinc-400 dark:text-zinc-500 mt-2 block">05.21.2026</span>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <div className="bg-white dark:bg-[#080b11]/60 border border-zinc-200 dark:border-zinc-900 rounded-lg p-5 flex flex-col justify-between transition-colors min-h-[145px] hover:border-emerald-500 relative group shadow-2xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm font-extrabold text-zinc-900 dark:text-white font-mono leading-none">DP Master</h4>
                <span className="text-[8.5px] text-zinc-500 font-mono tracking-wider uppercase mt-1 block">Dynamic Optimization</span>
              </div>
            </div>
          ...
          {/* Card 3: DB Architect */}
          <div className="bg-white dark:bg-[#080b11]/60 border border-zinc-200 dark:border-zinc-900 rounded-lg p-5 flex flex-col justify-between transition-colors min-h-[145px] hover:border-purple-500 relative group shadow-2xl">
            <div className="absolute top-0 right-0 w-2.5 h-2.5 border-t-2 border-r-2 border-purple-550" />
          ...
          <div className="bg-[#fcfcfc] dark:bg-[#080b11]/25 border border-zinc-200 dark:border-zinc-900/60 rounded-lg p-5 flex flex-col justify-between transition-colors min-h-[145px] relative opacity-55 shadow-2xl">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h4 className="text-sm font-extrabold text-zinc-450 dark:text-zinc-500 font-mono leading-none">Zero Day Fixer</h4>
                <span className="text-[8.5px] text-zinc-500 font-mono tracking-wider uppercase mt-1 block">Security Infrastructure</span>
              </div>
            </div>

            <div className="space-y-2 mt-4">
              <div className="w-full bg-zinc-100 dark:bg-[#121620]/40 rounded-full h-1.5 overflow-hidden">
                <div className="bg-zinc-350 dark:bg-zinc-800 h-1.5 rounded-full" style={{ width: '0%' }} />
              </div>
      ...
      <footer className="pt-6 border-t border-zinc-200 dark:border-[#171c26]/60 flex flex-wrap justify-between items-center gap-4 font-mono text-[9px] text-zinc-500 dark:text-zinc-550 leading-relaxed font-bold">
        <div className="flex gap-4">
          ...
          <span className="text-zinc-300 dark:text-zinc-800">/</span>
          <span className="text-zinc-450 dark:text-zinc-500 uppercase">V2.1.0-STABLE</span>
        </div>
        <div className="text-right space-y-0.5">
          <div>GROWCODE_OS // DISTRIBUTED_MEDAL_V03</div>
          <div className="text-[8.5px] text-zinc-550 dark:text-zinc-600">LATENCY: 14MS // ENCRYPTION: AES-256</div>
        </div>
      </footer>
